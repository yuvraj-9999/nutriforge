...
const GrainTexture = () => (
  ...
  >
    ...
    <rect width="100%" height="100%" filter="url(#nf-fp-grain)" />
  </svg>
);
...
const BrandMark = () => (
  ...
  >
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="fp-grad" x1="12" y1="2.5" x2="16.5" y2="20.5" gradientUnits="userSpaceOnUse">
        ...
        >
          ...
          <div className="px-8 pt-8 pb-8">
            ...
            <AnimatePresence mode="wait">
              {sent ? (
                <SuccessView key="success" email={email} />
              ) : (
                <motion.div
                  key="form"
                  initial={{ opacity: 0 }}
